      ...
      <div className="mx-auto max-w-screen-xl px-4 py-32">
        <div className="mx-auto max-w-xl text-center">
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-4">
            <a
              className="bg-primary border-primary  hover:text-primary text-primary-foreground rounded-[5px] px-5 relative inline-flex items-center justify-center p-0.5 mb-2 me-2"
              href="/sign-in"
            >
              Get Started
            </a>
