...
const ExpenseListTable = ({ expensesList,refreshData }) => {
  ...
  return (
    <div className='mt-3'>
      <div className='grid font-bold grid-cols-4 text-primary-foreground bg-primary p-2'>
        <h2>Name</h2>
        <h2>Amount</h2>
        <h2>Date</h2>
        <h2>Action</h2>
      ...
      {expensesList.map((expenses) => (
        <div key={expenses.id} className=' grid grid-cols-4 bg-primary-foreground p-2'>
          <h2 >{expenses.name}</h2>
